...
public abstract class UserPropertyDescriptor extends Descriptor<UserProperty> {
     ...
     *
     * <p> See {@link User} class javadoc for more details about the life cycle
     * of {@link User} and when this method is invoked.
     *
     * @return null if the implementation choose not to add any property object
     * for such user.
     */
     ...
     *
     * <p> Returning false from this method essentially has the same effect of
     * making Hudson behaves as if this {@link UserPropertyDescriptor} is not a
     * part of {@link UserProperty#all()}.
     *
     * <p> This mechanism is useful if the availability of the property is
