 ...
 *
 * <p> Despite what the name suggests, this class doesn't actually trigger other
 * jobs as a part of {@link #perform} method. Its main job is to simply augument
 ...
 *
 * <p> This class, however, does provide the
 * {@link #execute(AbstractBuild, BuildListener, BuildTrigger)} method as a
 * convenience method to invoke downstream builds.
 *
...
public class BuildTrigger extends Recorder implements DependecyDeclarer {
    ...
    /**
     * Checks if this trigger has the exact same set of children as the given
     * list.
     */
    ...
    /**
     * @deprecated since 1.341; use
     * {@link #execute(AbstractBuild,BuildListener)}
     */
    @Deprecated
    ...
    /**
     * Called from
     * {@link hudson.tasks.BuildTrigger.DescriptorImpl.ItemListenerImpl} when a
     * job is renamed.
     *
     * @return true if this {@link BuildTrigger} is changed and needs to be
     * saved.
     */
