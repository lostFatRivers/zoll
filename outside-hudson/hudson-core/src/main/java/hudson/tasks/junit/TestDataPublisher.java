 ...
 *
 * <p> To register your implementation, put {@link Extension} on your descriptor
 * implementation.
 *
 * @since 1.320
 */
public abstract class TestDataPublisher extends AbstractDescribableImpl<TestDataPublisher> implements ExtensionPoint {
     ...
     * for {@link TestAction}s.
     *
     * @return can be null to indicate that there's nothing to contribute for
     * this test result.
     */
