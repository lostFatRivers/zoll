 ...
 *
 * <h2>Special tokens</h2> <p> We allow a component to be not just a number, but
 * also "ea", "ea1", "ea2". "ea" is treated as "ea0", and eaN &lt; M for any M >
 * 0.
 *
 * <p> '*' is also allowed as a component, and '*' > M for any M > 0.
 *
 * <p> 'SNAPSHOT' is also allowed as a component, and "N.SNAPSHOT" is
 * interpreted as "N-1.*"
 *
 * <pre>
