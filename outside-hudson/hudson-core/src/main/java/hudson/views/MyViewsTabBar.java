 ...
 * {@link MyViewsProperty}.
 *
 * <p> This object must have the <tt>myViewTabs.jelly</tt>. This view is called
 * once when the My Views main panel is built. The "views" attribute is set to
 * the "Collection of views".
 *
 * <p> There also must be a default constructor, which is invoked to create a My
